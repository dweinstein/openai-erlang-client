-module(openai_create_moderation_response_results_inner_category_scores).

-export([encode/1]).

-export_type([openai_create_moderation_response_results_inner_category_scores/0]).

-type openai_create_moderation_response_results_inner_category_scores() ::
    #{ 'hate' := integer(),
